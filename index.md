...
- [2026-04-12] [[andrej-karpathy-blog|Andrej Karpathy Blog]] — LLM 知识管理先驱博客
- [2026-04-12] [[karpathy-llm-wiki-workflow|Karpathy LLM Wiki 工作流]] — 知识库编译工作流方法论
- [2026-04-12] [[ai-high-quality-dataset|AI时代高质量数据集]] — 大模型数据工程四个关键本质
- [2026-04-12] [[huawei-ai-transformation|华为AI赋能企业数智化转型]] — 智能制造与AI落地案例
- [2026-04-26] [[zhihu-ai-product-dev|知乎产研AI赋能]] — 人机协同：效能提升38.6%、每周节省25人天的全链路实战
- [2026-04-26] [[andrew-ng-2025-ai-trends|吴恩达2025 AI四大趋势]] — 推理模型标配/人才战/数据中心工业时代/Agent编程主导
- [2026-04-26] [[apple-taste|品味]] — 苹果50年设计哲学：价值理性 > 工具理性，AI时代品味愈发重要
- [2026-04-26] [[harness-engineering-ontology|Harness 本体驱动方案]] — 用 Ontology 为 Agent 提供语义底座，实现业务结构可控
- [2026-04-26] [[software-quality-management|研发质量管理全景]] — 质量评价模型/红黑榜/质量成本/SQA破困之路
- [2026-04-26] [[bi-dashboard-cockpit|BI/大屏/驾驶舱区分]] — 找答案 vs 讲故事 vs 下指令，企业数据项目的烂尾根源
...
- [2026-04-06] [[07-Clippings/xhs-家居-weekly-2026-04-06]] — 小红书家居赛道热点分析
- [2026-04-11] [[07-Clippings/xhs-jiaju-weekly-2026-04-11]] — 小红书家居赛道周报
...
- `06-Evergreen/` — 常青笔记
- `07-Clippings/` — 裁剪内容
- `wiki/concepts/` — AI 建模页面
- `sources/articles/` — 原始网页存档
- `wiki/MOC/` — 主题地图（待建设）
